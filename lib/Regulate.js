...
;(function (window) {
    ...
    /**
     * Regulate#charIn([negated,] ...char) => {Regulate}
     *
     ...
     *   ...char      {String | Array}     Any number of characters or simple ranges to include in the class
     */
